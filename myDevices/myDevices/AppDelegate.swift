...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func addTestData() {
        ...
        for i in 1...10 {
            ...
            device.name = "\(device.deviceType) #\(i)"
            
        }
        
        guard let personEntity = NSEntityDescription.entityForName("Person", inManagedObjectContext: managedObjectContext) else {
            fatalError("Could not find entity description")
        }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "con.synerzip.myDevices" in the application's documents Application Support directory.
